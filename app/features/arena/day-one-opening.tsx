    ...
    <section className="bloodbath-opening" aria-labelledby="bloodbath-opening-title">
      <div className="bloodbath-opening__content">
        ...
        <p className="bloodbath-opening__description">
          The {tributeCount} tributes stand on their platforms, anxiously waiting for the starting
          cannon. In the distance, the great steel Cornucopia overflows with weapons and supplies.
          Each tribute must choose: risk the Bloodbath to gather supplies, or run straight for the
          trees and survive with whatever they can find.
        </p>
