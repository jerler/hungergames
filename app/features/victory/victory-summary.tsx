  ...
  return (
    <main className="victory-summary">
      <section className="victory-summary__content">
        ...
        <h1>{isJointVictory ? "The victors are..." : "The victor is..."}</h1>
        ...
        >
          {victors.map((victor) => (
            <div className="victory-summary__card" key={victor.id}>
        ...
        <p className="victory-summary__copy">
          {isJointVictory
            ? `${victorNames} defied the Capitol and survived the Games together.`
            : `${victorNames} is the sole survivor of a field of ${game.tributes.length} tributes.`}
        </p>
